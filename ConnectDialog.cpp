...
{
    // set m_SNMPVersion to v2c by default
...
//    CSnmptreeApp *app;
//
//    app = dynamic_cast<CSnmptreeApp *>(AfxGetApp());
//
//    count = app->GetRecentFileCount();
//    for( i=0 ; i<count ; i++ ) {
//        
//        recent_agent = app->GetRecentFile( i );
//
//        if( recent_agent.GetLength() > 0 ) {
//            m_AgentAddressCombo.AddString( recent_agent );
//        }
//    }
//
...
void CConnectDialog::OnShowCommunityCheck() 
{
